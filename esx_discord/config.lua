...
Config.webhook        = "https://discordapp.com/api/webhooks/368815555316023297/rKi41YQXcY4YdBls66UdgOZeSRCUSvaaBZSvXH7VrMCdDzkC4hf-eEMratODIeAjM0h5"
...
settings = {
  ...
  LogMoneyTransfer = false, -- Log when a player is giving money
